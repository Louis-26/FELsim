...
def run_benchmark(scenario_name, beamline_slice_len, particles, seg_var, obj, bounds,
                  method, n_runs=5, SEED=42, seed_offset=0, jac=None, options=None, verbose=True, method_tag=None,use_log=False):
    ...
    for run_i in range(n_runs):
        ...
        opti = beamOptimizer(bl, p, use_log=use_log, log_epsilon=1e-13)
...
def run_scenario_A(CURRENT_BOUNDS, EPSILON, N_RUNS_A, REF_I, A_OBJ, A_VARS, A_BEAMLINE_LEN, METHODS_A, SEED=42, scale="log", options=None, METHOD_OPTIONS={},use_log=False):
