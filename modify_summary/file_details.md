...
## 8) `backend/AlgebraicOptimization.py`
...
## 9) `backend/physicalConstants.py`
...
## Test / experiment scripts (`backend/test/`)
...
2. **Physics kernels:** `beamline.py`, `ebeam.py`, `schematic.py`, `excelElements.py`
3. **Optimization:** `beamOptimizer.py`, `AlgebraicOptimization.py`
4. **Auxiliary studies/utilities:** `physicalConstants.py`, `beamUtility.py`, `radiation.py`, `main.py`
5. **Experiments/tests:** `backend/test/*.py`
